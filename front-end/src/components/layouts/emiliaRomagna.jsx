...
function build(txt, img, tre) {
  ...
  temp = (
    <div className="video-container">
      <YoutubeEmbed embedId="xzlx8pHlpko" />
    </div>
  );
  struttura.push(temp);
  ...
  temp = <div className="testo">{txt[0]}</div>;
  struttura.push(temp);
  ...
  temp = (
    <div className="wrapperP">
      <div className="evidenza">
        ...
        <div className="imgdescription">{txt[4]}</div>
      </div>
      ...
      <div className="evidenza">
        ...
        <div className="imgdescription">{txt[5]}</div>
      </div>
      ...
      <div className="evidenza">
        ...
        <div className="imgdescription">{txt[6]}</div>
      </div>
      ...
      <div className="evidenza">
        ...
        <div className="imgdescription">{txt[7]}</div>
      </div>
    </div>
  );
