  ...
  layout(txt, img, tre) {
    ...
    switch(this.state.pagina)
    {
     ...
     struttura.push(temp);
      ...
      <a href="/meridiana"><img class="icona" id="meridiana" src="/bologna/img/2"/></a>
      <a href="/certosa"><img class="icona" id="certosa" src="/bologna/img/3"/></a>
      <a href="/torri"><img class="icona" id="dueTorri" src="/bologna/img/4"/></a>
      <a href="/pinacoteca"><img class="icona" id="pinacoteca" src="/bologna/img/5"/></a>
      <a href="/pellegrino"><img class="icona" id="pellegrino" src="/bologna/img/6"/></a>
      </div>)
      struttura.push(temp);
      break;
